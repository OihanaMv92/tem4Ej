...
public class EventoList extends Frame implements WindowListener, ActionListener
{
	...
	List lista = new List ( 4, false ); // 4 lo que quieres que se vea false significa que solo puedes elegir 1 elemento
	public EventoList()
	{
	...
	{
		if("Rojo".equals(lista.getSelectedItem())) // oye rojo es el elemento de la lista que emos selecionado?
		{
